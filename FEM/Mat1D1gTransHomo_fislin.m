function params = Mat1D1gTransHomo_fislin()
% Reactor homogeneo 1G sin precursores, perturbacion lineal en fision

    params.nombre = 'Mat1D1gTransHomo_fislin';
    params.G = 1;
    ...
    params.nu_sigma_f_func{1,1} = @(t) params.nu_sigma_f_0 + params.pert_f * t;
