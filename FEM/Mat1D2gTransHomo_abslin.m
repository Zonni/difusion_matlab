function params = Mat1D2gTransHomo_abslin()
% Reactor homogeneo 2G sin precursores con perturbacion lineal en absorcion

    params.nombre = 'Mat1D2gTransHomo_abslin';
    params.G = 2;
    ...
    params.sigma_a_func{2,1} = @(t) params.sigma_a_0(2) + params.pert_a * t;
