function params = Mat1D1gTransHomo_absesc()
% Reactor homogeneo 1G sin precursores, perturbacion escalon en absorcion

    params.nombre = 'Mat1D1gTransHomo_absesc';
    params.G = 1;
    ...
    params.sigma_a_func{1,1} = @(t) params.sigma_a_0 + params.pert_a;
