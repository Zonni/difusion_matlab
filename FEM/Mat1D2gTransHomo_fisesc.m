function params = Mat1D2gTransHomo_fisesc()
% Reactor homogeneo 2G sin precursores con perturbacion escalon en fision

    params.nombre = 'Mat1D2gTransHomo_fisesc';
    params.G = 2;
    ...
    params.nu_sigma_f_func{2,1} = @(t) params.nu_sigma_f_0(2) + params.pert_f;
